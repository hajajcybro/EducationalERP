...
class EduAnalyticsEnrollmentSummary(models.Model):
    ...
    graduated_count = fields.Integer(string="Graduated", readonly=True)
...
class EduAnalyticsFeeCollection(models.Model):
    ...
    total_outstanding = fields.Float(string="Total Outstanding", readonly=True)
    overdue_count = fields.Integer(string="Overdue Count", readonly=True)
...
class EduAnalyticsExamPassRate(models.Model):
    ...
    passed_count = fields.Integer(string="Passed", readonly=True)
