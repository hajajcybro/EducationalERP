...
################################################################################
{
    ...
    'version': '17.0.1.0.0',
    'summary': """Manage Students portal & online admission  in Educational
     ERP""",
    'description': 'Manage the students portal and online admission processes '
                   'within the educational ERP system. Students can view their '
                   'details from their portal and take online admission.',
