...
class EducationStudent(models.Model):
    ...
    location = fields.Many2one('education.stop', string='Location',
                               track_visibility='onchange',
                               help="Select the stop location for the student.")
    trans_cost = fields.Float(string="Transportation Fee",
                              related='location.cost',
                              track_visibility='onchange',
                              help="The transportation fee based on the stop "
                                   "location.")
    need_transportation_facility = fields.Boolean(string='Need Transportation Facility',
                                                  default=False,
