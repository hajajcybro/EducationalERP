...
class EducationFeeCategory(models.Model):
    """Creates the model education fee category"""
    ...
    fee_structure = fields.Boolean(string='Have a fee structure?',
                                   ...
                                   help='If any fee structure want to be '
                                        'included in this category you must '
                                        'click here. For an example Institution'
                                        ' category have different kind of fee '
                                        'structures for different syllabuses')
