...
class UniversityDocuments(models.Model):
    ...
    name = fields.Char(string="Reference No.", copy=False, required=True,
                       readonly=True, help="Sequence of the document",
    ...
    def create(self, vals):
        ...
        return super(UniversityDocuments, self).create(vals)
