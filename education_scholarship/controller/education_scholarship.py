...
class ScholarshipPortal(http.Controller):
    ...
    def portal_published_scholarships(self, **kwargs):
        ...
        return request.render(
            'education_scholarship.portal_published_scholarships',
            {
    ...
    def scholarship_application(self, **kwargs):
        ...
        return request.render(
            'education_scholarship.portal_apply_scholarship',
            {
                'scholarships': scholarships,
    ...
    def submit_scholarship(self, **post):
        ...
        return request.render('education_scholarship.application_success')
    ...
    def portal_my_scholarship(self, **kwargs):
        ...
        return request.render(
            'education_scholarship.portal_my_scholarship',
            {
